...
class LikeSystem(TestCase):
    ...
    def test_submit_likes_without_login(self):
        ...
        post = Post.objects.create(title='test', description='tester', topic=Topic.objects.get(topic_name='Hello'), user=users)
    ...
    def test_submit_likes_with_login(self):
        ...
        topic = Topic.objects.create(topic_name='Hello', category='New')
        post = Post.objects.create(title='test', description='tester', topic=Topic.objects.get(topic_name='Hello'),
                                   user=users)
        response = self.client.post(reverse('likes', args=[post.pk]), follow=True)
